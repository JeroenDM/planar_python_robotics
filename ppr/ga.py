...
class GASolver():
    ...
    def __init__(self, Q, T_run=None, cross_rate=0.8, mut_rate=0.1, pop_size=30, gen=100):
        self.Q = Q
        self.n_path = len(Q)
    ...
    def run(self):
        if self.T == None:
            return self.run_gen_limited()
        else:
            return self.run_time_limited()

    def run_gen_limited(self):
