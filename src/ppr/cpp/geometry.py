...
def create_rotation_matrix(angle):
    return _geometry.create_rotation_matrix(angle)
create_rotation_matrix = _geometry.create_rotation_matrix
class Rectangle(_object):
    ...
    def set_pose(self, px, py, a):
        return _geometry.Rectangle_set_pose(self, px, py, a)

    def set_size(self, dx, dy):
        return _geometry.Rectangle_set_size(self, dx, dy)

    def is_in_collision(self, other):
        return _geometry.Rectangle_is_in_collision(self, other)

    def get_vertices(self):
        return _geometry.Rectangle_get_vertices(self)
